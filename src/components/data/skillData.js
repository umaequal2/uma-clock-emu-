function normalSkillData(thiz) {
    return [
        ...
        {
            variants: [
                { rarity: "normal", id: 201621, name: "ふり絞り", heal: 150 },
            ],
            check: function () {
                return (
                    thiz.skillTriggerCount[2] + thiz.skillTriggerCount[3] >= 3
                );
            },
        },
        {
        ...
        {
            variants: [
                { rarity: "all", id: 201012, name: "後方釘付", speed: -0.2 },
            ],
            duration: 3,
        ...
        {
            variants: [
                { rarity: "all", id: 201011, name: "悩殺術", speed: -0.25 },
            ],
            duration: 3,
            conditions: { distance_type: 1, phase_random: 0 },
        },
        ...
        {
            variants: [
                { rarity: "all", id: 201152, name: "束縛", speed: -0.15 },
            ],
            duration: 3,
        ...
        {
            variants: [
                { rarity: "all", id: 201151, name: "独占力", speed: -0.25 },
            ],
            duration: 3,
            conditions: { distance_type: 3, phase_random: 2 },
        },
        ...
        {
            variants: [
                { rarity: "all", id: 201512, name: "まなざし", speed: -0.15 },
            ],
            duration: 3,
            conditions: { phase_random: 2 },
        },
        ...
        {
            variants: [
                { rarity: "all", id: 200841, name: "逃げ焦り", fatigue: 100 },
            ],
            conditions: { running_style: 1, phase_random: 1 },
        },
        {
        ...
        {
            variants: [
                { rarity: "all", id: 200861, name: "先行焦り", fatigue: 100 },
            ],
            conditions: { running_style: 2, phase_random: 1 },
        },
        {
        ...
        {
            variants: [
                { rarity: "all", id: 200901, name: "差し焦り", fatigue: 100 },
            ],
            conditions: { running_style: 3, phase_random: 1 },
        },
        {
        ...
        {
            variants: [
                { rarity: "all", id: 200931, name: "追込焦り", fatigue: 100 },
            ],
            conditions: { running_style: 4, phase_random: 1 },
        },
        {
        ...
        {
            variants: [
                { rarity: "all", id: 201162, name: "ささやき", fatigue: 100 },
            ],
            conditions: { distance_type: 3, phase_random: 1 },
        },
        {
        ...
        {
            variants: [
                { rarity: "all", id: 201442, name: "鋭い眼光", fatigue: 100 },
            ],
            conditions: { phase_random: 2 },
        },
        {
        ...
        },
        {
            ...
            trigger: function () {
                if (
                    thiz.umaStatus.speed >= 1200 &&
                    thiz.umaStatus.wisdom >= 1200
                ) {
                    thiz.passiveBonus.speed += 100;
        ...
        {
            variants: [
                { rarity: "rare", id: 202701, name: "シンギュラリティ" },
            ],
            type: "passive",
            conditions: { running_style: 2, distance_type: 3 },
            trigger: function () {
...
const uniqueSkillData = (thiz) => [
    ...
    },
    {
        ...
        check: function () {
            return (
                thiz.isInStraight() && thiz.position >= thiz.courseLength * 0.5
            );
        },
    },
    {
    ...
    },
    {
        ...
        trigger: function (skill) {
            ...
            skill.targetSpeed =
                0.25 +
                (thiz.passiveTriggered > 5 ? 3 : rate[thiz.passiveTriggered]) *
                    0.05;
            skill.acceleration =
                (thiz.passiveTriggered > 5 ? 3 : rate[thiz.passiveTriggered]) *
                0.05;
